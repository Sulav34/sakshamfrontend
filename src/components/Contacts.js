    ...
    render() {
      ...
      <section className="page-section" id="About">
          <div className="container">
            <div className="row">
              <div className="col-lg-12 text-center">
                <h2 className="section-heading text-uppercase">Learn more About Us</h2>
                <h3 className="section-subheading text-muted">Contact Details</h3>
              </div>
            </div>
            <div className="row text-center">
            <div className="col-md-4">
                <h4 className="service-heading">Address</h4>
                <p> Newroad-23, Kathmandu, Nepal</p>
              ...
              <div className="col-md-4">
                ...
                <p>+977-1-4247138</p>
                <br></br>
                <Button variant="primary" href="/Login">Keep in Touch with us</Button>
              </div>
              <div className="col-md-4">
                <h4 className="service-heading">Email</h4>
                <p>Daily Deals7@gmail.com</p>
              </div>
            </div>
          </div>
        </section>
