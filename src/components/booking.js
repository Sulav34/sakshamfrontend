        ...
        return (
            <div className="App">
              ...
              <i className="fa fa-bars"></i>
                ...
                <li className="nav-item">
                  <Link className="nav-link js-scroll-trigger" to="/Products">All Product</Link>
                </li>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              <h2 className="section-heading text-uppercase">About Our Produts</h2>
              <h3 className="section-subheading text-muted">Want to know more?</h3>
                ...
                <section className="page-section" id="booking">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <h2 className="section-heading text-uppercase">Book Here Now</h2>
                                <h3 className="section-subheading text-muted">Enjoy our products.</h3>
                            </div>
                        </div>
                                    ...
                                    <Form onSubmit={this.handleSubmit}>
                                        ...
                                        >
                                            ...
                                            <FormGroup>
                                             ...
                                             <Button variant="primary" size="sm" block onClick={this.handleSubmit.bind(this,"Successful")} >Book Right Now</Button>
                                        </fieldset>
                                    </Form>
                                </div>
                            </Container>
                ...
                <footer className="footer">
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <span className="copyright">Copyright &copy; Daily Deals 2021</span>
                            </div>
                            <div className="col-md-4">
